...
4. Portfolio Viewing
As a user, I want to view my portfolio (including the stocks I hold and their current value) so that I can understand my asset composition.
 
5. Real-Time Stock Prices
As a player, I want to view real-time stock prices on the market page so that I can understand current market conditions.
...
7. Buy Stocks
As a user, I want to purchase a specified quantity of stocks so that I can invest and earn returns.
 
8. Sell Stocks
As a user, I want to sell the stocks I hold so that I can realize profits or reduce losses.
...
10. Leaderboard
As a user, I want to view a leaderboard so that I can compare my performance with other users. 
